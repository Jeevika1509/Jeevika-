...
public class WeopanRunner {
	...
	public static void main(String[] args) {
		...
		collection.add(new WeaponDTO("UMP45", "China", "1952", 8000, Type1.SubMachine));
		collection.add(new WeaponDTO("Vector", "Russia", "1997", 5000, Type1.SubMachine));
		collection.add(new WeaponDTO("Thompson", "Australia", "1909", 3500, Type1.SubMachine));
		collection.add(new WeaponDTO("Bizon", "Japan", "1922", 2000, Type1.SubMachine));
		collection.add(new WeaponDTO("S686", "India", "1954", 6000, Type1.Shotgun));
		collection.add(new WeaponDTO("S1897", "China", "1965",5800, Type1.Shotgun));
		collection.add(new WeaponDTO("S12K", "Australia", "1985", 4500, Type1.Shotgun));
		collection.add(new WeaponDTO("DBS", "India", "1954", 5000, Type1.Shotgun));
		collection.add(new WeaponDTO("Skorpion", "India", "2000", 1000, Type1.Pistol));
		collection.add(new WeaponDTO("Pan", "UK", "1999", 500, Type1.Melee));
		collection.add(new WeaponDTO("AKM", "India", "1989", 20000, Type1.AssualtRifles));
		collection.add(new WeaponDTO("M16A4", "Russia", "1978", 3000, Type1.AssualtRifles));
		collection.add(new WeaponDTO("M416", "USA", "1958", 5000, Type1.AssualtRifles));
		collection.add(new WeaponDTO("Groza", "UK", "1966", 9000, Type1.AssualtRifles));
		collection.add(new WeaponDTO("AUG A3", "India", "1999", 3500, Type1.AssualtRifles));
		collection.add(new WeaponDTO("Kar98", "Russia", "1925", 9500, Type1.Sniper));
		collection.add(new WeaponDTO("M24", "Japan", "1975", 23000, Type1.Sniper));
		collection.add(new WeaponDTO("AWM", "USA", "1973", 25000, Type1.Sniper));
		collection.add(new WeaponDTO("Win98", "India", "1922", 1000, Type1.Sniper));
		collection.add(new WeaponDTO("UZI", "Japan", "1955", 12000, Type1.SubMachine));
